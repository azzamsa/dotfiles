...
M.color_schemes = {
    ...
    ["modus_vivendi"] = {
        -- ansi = { "#9399b2", "#ff7f86", "#80e080", "#efef80", "#79a8ff", "#b6a0ff", "#4ae2f0", "#ffffff" },
        ansi = { "#9399b2", "#ff7f86", "#6ae4b9", "#dfaf7a", "#00bcff", "#f78fe7", "#4ae2f0", "#ffffff" },
        brights = { "#9399b2", "#ff7f86", "#6ae4b9", "#dfaf7a", "#00bcff", "#f78fe7", "#4ae2f0", "#ffffff" },
